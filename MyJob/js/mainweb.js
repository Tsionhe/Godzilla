...
;(function(window) {
	...
	GridFx.prototype._openItem = function(ev, item) {
		...
		if( descriptionEl ) {
			this.previewDescriptionEl.innerHTML = "";
			var T = this;
			setTimeout(function(){
				T.previewDescriptionEl.innerHTML = descriptionEl.innerHTML;
				$(".details span.link").click(function() {
					var url = $(this).html();
	...
	GridFx.prototype._setOriginal = function(src) {
		...
		this.originalImg.setAttribute('src', "");
